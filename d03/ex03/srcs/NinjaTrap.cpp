...
NinjaTrap::NinjaTrap()
{
	...
	this->sigfault = 50;
	this->armor = 0;
	std::cout << "Recompiling my NINJA combat code!" << std::endl;
}
...
NinjaTrap::NinjaTrap(std::string name)
{
	...
	this->sigfault = 50;
	this->armor = 0;
	std::cout << this->name << " is here to fight as a NINJA" << std::endl;
}
...
NinjaTrap::NinjaTrap(const NinjaTrap &src)
{
	...
	std::cout << "Copying my NINJA combat code!" << std::endl;
}
